...
% \linenumbers
\input{Kapitel/1_Introduction} % Externe Datei einbinden
\input{Kapitel/2_Fundamentals.tex}
\input{Kapitel/2_State_of_the_Art} % Externe Datei einbinden
\input{Kapitel/3_Methodik_alt.tex} % Externe Datei einbinden
\input{Kapitel/3_Methodology} % Externe Datei einbinden
\input{Kapitel/4_Results} % Externe Datei einbinden
%\input{Kapitel/5_Comparison} % Externe Datei einbinden
\input{Kapitel/5_Conclusion} % Externe Datei einbinden
...
% \input{kapitel/9_abkuerzungen.tex}
